...
# buttons =  [10 ,11, 13, 14, 3, 5, 6, 8, 16, 17, 19, 21, 20, 18, 15, 1, 2, 4, 7, 9, 12]
...
# button_data = [10 ,11, 13, 14, 3, 5, 6, 8, 16, 17, 19, 21, 20, 18, 15, 1, 2, 4, 7, 9, 12]
...
# find the button that has the nearest distance from entrance
    def findGoalButton(clicked):
        ...
        file.write(str(goal[goalButtonIndex]))
        file.close()
        ...
        #MainWindow.label_2.setStyleSheet("QLabel { background-color: color}")
